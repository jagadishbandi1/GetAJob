...
const tabs = [
  {
    ...
    icon: (active: boolean) => (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
        ...
        {active && <rect x="3" y="3" width="8" height="5" rx="1.5" fill={ACCENT} opacity="0.15" />}
        {active && <rect x="3" y="11" width="8" height="10" rx="1.5" fill={ACCENT} opacity="0.15" />}
      </svg>
    ),
  },
  {
  ...
  },
  {
    ...
    icon: (active: boolean) => (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
        <rect x="3" y="13" width="4" height="8" rx="1" fill={active ? ACCENT : MUTED} opacity={active ? 1 : 0.5} />
        <rect x="10" y="8" width="4" height="13" rx="1" fill={active ? ACCENT : MUTED} opacity={active ? 1 : 0.5} />
        <rect x="17" y="3" width="4" height="18" rx="1" fill={active ? ACCENT : MUTED} opacity={active ? 1 : 0.5} />
      </svg>
    ),
  },
];
